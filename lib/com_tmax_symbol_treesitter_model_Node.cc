...
#include "com_tmax_symbol_treesitter_model_Node.h"
#include <jni.h>
#include <string.h>
#include <tree_sitter/api.h>

JNIEXPORT jobject JNICALL Java_com_tmax_symbol_treesitter_model_Node_getChild(
...
JNIEXPORT jobject JNICALL Java_com_tmax_symbol_treesitter_model_Node_getChildByFieldName(
...
JNIEXPORT jint JNICALL Java_com_tmax_symbol_treesitter_model_Node_getChildCount(
...
JNIEXPORT jobjectArray JNICALL Java_com_tmax_symbol_treesitter_model_Node_getChildren(
...
JNIEXPORT jobject JNICALL Java_com_tmax_symbol_treesitter_model_Node_getDescendant__IIZ(
...
JNIEXPORT jobject JNICALL Java_com_tmax_symbol_treesitter_model_Node_getDescendant__Lcom_tmax_symbol_treesitter_model_Point_2Lcom_tmax_symbol_treesitter_model_Point_2Z(
...
JNIEXPORT jint JNICALL Java_com_tmax_symbol_treesitter_model_Node_getEndByte(
  JNIEnv* env, jobject thisObject) {
  TSNode node = __unmarshalNode(env, thisObject);
  return ts_node_is_null(node) ? (jint)0 : (jint)ts_node_end_byte(node) / 2;
}

JNIEXPORT jobject JNICALL Java_com_tmax_symbol_treesitter_model_Node_getEndPoint(
  JNIEnv* env, jobject thisObject) {
  TSNode node = __unmarshalNode(env, thisObject);
...
JNIEXPORT jstring JNICALL Java_com_tmax_symbol_treesitter_model_Node_getFieldNameForChild(
...
JNIEXPORT jobject JNICALL Java_com_tmax_symbol_treesitter_model_Node_getFirstChildForByte(
...
JNIEXPORT jobject JNICALL Java_com_tmax_symbol_treesitter_model_Node_getNextSibling(
  JNIEnv* env, jobject thisObject, jboolean named) {
...
JNIEXPORT jobject JNICALL Java_com_tmax_symbol_treesitter_model_Node_getPrevSibling(
  JNIEnv* env, jobject thisObject, jboolean named) {
...
JNIEXPORT jobject JNICALL Java_com_tmax_symbol_treesitter_model_Node_getParent(
  JNIEnv* env, jobject thisObject) {
  TSNode node = __unmarshalNode(env, thisObject);
...
JNIEXPORT jint JNICALL Java_com_tmax_symbol_treesitter_model_Node_getStartByte(
  JNIEnv* env, jobject thisObject) {
  TSNode node = __unmarshalNode(env, thisObject);
  return ts_node_is_null(node) ? (jint)0 : (jint)ts_node_start_byte(node) / 2;
}

JNIEXPORT jobject JNICALL Java_com_tmax_symbol_treesitter_model_Node_getStartPoint(
  JNIEnv* env, jobject thisObject) {
  TSNode node = __unmarshalNode(env, thisObject);
  if (ts_node_is_null(node)) return env->CallStaticObjectMethod(_pointClass, _pointOriginStaticMethod);
...
JNIEXPORT jobject JNICALL Java_com_tmax_symbol_treesitter_model_Node_getSymbol(
  JNIEnv* env, jobject thisObject) {
...
JNIEXPORT jstring JNICALL Java_com_tmax_symbol_treesitter_model_Node_getType(
  JNIEnv* env, jobject thisObject) {
  TSNode node = __unmarshalNode(env, thisObject);
  if (ts_node_is_null(node)) return NULL;
...
JNIEXPORT jboolean JNICALL Java_com_tmax_symbol_treesitter_model_Node_hasError(
  JNIEnv* env, jobject thisObject) {
  TSNode node = __unmarshalNode(env, thisObject);
  return ts_node_has_error(node) ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT jboolean JNICALL Java_com_tmax_symbol_treesitter_model_Node_isExtra(
  JNIEnv* env, jobject thisObject) {
  TSNode node = __unmarshalNode(env, thisObject);
  return ts_node_is_extra(node) ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT jboolean JNICALL Java_com_tmax_symbol_treesitter_model_Node_isMissing(
  JNIEnv* env, jobject thisObject) {
  TSNode node = __unmarshalNode(env, thisObject);
  return ts_node_is_missing(node) ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT jboolean JNICALL Java_com_tmax_symbol_treesitter_model_Node_isNamed(
  JNIEnv* env, jobject thisObject) {
  TSNode node = __unmarshalNode(env, thisObject);
  return ts_node_is_named(node) ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT jboolean JNICALL Java_com_tmax_symbol_treesitter_model_Node_isNull(
  JNIEnv* env, jobject thisObject) {
  TSNode node = __unmarshalNode(env, thisObject);
  return ts_node_is_null(node) ? JNI_TRUE : JNI_FALSE;
}

JNIEXPORT jboolean JNICALL Java_com_tmax_symbol_treesitter_model_Node_equals(
...
JNIEXPORT jobject JNICALL Java_com_tmax_symbol_treesitter_model_Node_walk__(
  JNIEnv* env, jobject thisObject) {
  jobject treeObject = env->GetObjectField(thisObject, _nodeTreeField);
  if (treeObject == NULL) {
...
JNIEXPORT jobject JNICALL Java_com_tmax_symbol_treesitter_model_Node_walk__Lcom_tmax_symbol_treesitter_model_Query_2(
